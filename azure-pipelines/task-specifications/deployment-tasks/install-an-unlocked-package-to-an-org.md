...
| Task Id | Version |
| :--- | :--- |
| sfpwowerscript-installunlockedpackage-task | 10.0.0 |
...
* **Skip installation of package, if its already installed in the org** / skip\_if\_package\_installed Once enabled, the command will skip if the package is already installed in the target org.  It utilizes **sfpowerkit:package:version:info** command to probe the org whether a package with the provided id is installed in the org and skips the installation
{% endtab %}
...
* 10.0.0
  * \#57 Skip Installation of package , if its already installed in the org
* 9.2.0
