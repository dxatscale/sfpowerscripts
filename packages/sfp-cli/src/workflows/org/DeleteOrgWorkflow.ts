import SFPLogger, { COLOR_ERROR, COLOR_KEY_VALUE } from "@dxatscale/sfpowerscripts.core/lib/logger/SFPLogger";
...
export default class DeleteOrgWorkflow {
  ...
  public async execute() {
    ...
    if (isDeleteOrgConfirmation) {
      ...
      {
        SFPLogger.log(`${COLOR_ERROR(`Unable to delete this dev org, You may need to delete this from ${this.sfpProjectConfig.repoProvider} pipelines`)}`);
      }
    }
    cli.action.stop();
  }
