...
describe("Given a URL", () => {
  ...
  it("should extract the domain name for https", () => {
    expect(extractDomainFromUrl("https://force-power-8147.cs115.my.salesforce.com")).toBe("force-power-8147.cs115.my.salesforce.com");
  });
  ...
  it("should extract only the domain name", () => {
    expect(extractDomainFromUrl("https://company.lightning.force.com/lightning/o/Account/list?filterName=00B4Y000000VyMDUA0")).toBe("company.lightning.force.com");
  });
