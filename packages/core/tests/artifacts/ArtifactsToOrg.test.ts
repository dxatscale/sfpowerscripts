...
describe('Fetch a list of sfpowerscripts artifacts from an org', () => {
    ...
    it('Return a  blank list of sfpowerscripts artifact, if there are no previously installed artifacts ', async () => {
        ...
        let artifacts = await InstalledAritfactsFetcher.getListofArtifacts('testOrg');
    ...
    it('Return a list of sfpowerscripts artifact, if there are previously installed artifacts ', async () => {
        ...
        let artifacts = await InstalledAritfactsFetcher.getListofArtifacts('testOrg2');
    ...
    it('Should return artifacts from stored query result for repeated calls', async () => {
        ...
        // Repeat call
        artifacts = await InstalledAritfactsFetcher.getListofArtifacts('testOrg2');
    ...
    it('Should get artifacts from the correct org', async () => {
        ...
        let artifactsTestOrg1 = await InstalledAritfactsFetcher.getListofArtifacts('testOrg1');
        ...
        let artifactsTestOrg2 = await InstalledAritfactsFetcher.getListofArtifacts('testOrg2');
...
describe('Update a sfpowerscripts artifact to an org', () => {
    ...
    it('Update a sfpowerscripts artifact, installing it the first time', async () => {
        ...
        let result = await ArtifactInstallationStatusUpdater.updatePackageInstalledInOrg(
            new VoidLogger(),
            'testorg',
            packageMetadata
        );
    ...
    it('Update a sfpowerscripts artifact and resulting an error,should return falsy', () => {
        ...
        expect(
            ArtifactInstallationStatusUpdater.updatePackageInstalledInOrg(new VoidLogger(), 'testorg', packageMetadata)
        ).resolves.toBeFalsy;
    });
});
