...
5. **\*\*\*\***[**promote**](../commands/promote.md) **\(sfdx sfpowerscripts:orchestrator:promote\)** : Promote enables the packages to be deployable to production. This explicit stage prevents incorrectly tested packages to reach production    
